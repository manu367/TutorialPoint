   ...
   return new Promise(function(resolve, reject) {
      setTimeout(function(){
         ...
         $('body').append(
            ...
            '<img id="xs-progress-icon" class="xs-progress-icon" src="http://localhost:8085/admin_war_exploded/static_folder/javascript/themes/loading.gif"><div id="xs-progress-bar" class="xs-progress-bar"></div>'+
            '</div>'
         );
